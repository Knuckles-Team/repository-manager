...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [OPTIONS](https://git-scm.com/docs/git-upload-pack#_options)
    * [ENVIRONMENT](https://git-scm.com/docs/git-upload-pack#_environment)
    * [SECURITY](https://git-scm.com/docs/git-upload-pack#_security)
    * [SEE ALSO](https://git-scm.com/docs/git-upload-pack#_see_also)
    * [GIT](https://git-scm.com/docs/git-upload-pack#_git)


[ English ▾](https://git-scm.com/docs/git-upload-pack)
Localized versions of **git-upload-pack** manual
  1. [English ](https://git-scm.com/docs/git-upload-pack)
  2. [Português (Brasil) ](https://git-scm.com/docs/git-upload-pack/pt_BR)
  3. [Svenska ](https://git-scm.com/docs/git-upload-pack/sv)
...
Most Git commands should not be run in an untrusted `.git` directory (see the section `SECURITY` in [git[1]](https://git-scm.com/docs/git)). `upload-pack` tries to avoid any dangerous configuration options or hooks from the repository it's serving, making it safe to clone an untrusted directory and run commands on the resulting clone.
...
##  [](https://git-scm.com/docs/git-upload-pack#_see_also)SEE ALSO
