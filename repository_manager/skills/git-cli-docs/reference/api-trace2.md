...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [Trace2 API](https://git-scm.com/docs/api-trace2#_trace2_api)
    * [Trace2 Target Formats](https://git-scm.com/docs/api-trace2#_trace2_target_formats)
    * [Example Trace2 API Usage](https://git-scm.com/docs/api-trace2#_example_trace2_api_usage)
    * [Future Work](https://git-scm.com/docs/api-trace2#_future_work)


[ English ▾](https://git-scm.com/docs/api-trace2)
Localized versions of **api-trace2** manual
  1. [English ](https://git-scm.com/docs/api-trace2)

Want to read in your language or fix typos?
[You can help translate this page](https://github.com/jnavila/git-manpages-l10n).
[Topics ▾](https://git-scm.com/docs/api-trace2)
### Setup and Config
...
[ Latest version ▾ ](https://git-scm.com/docs/api-trace2) api-trace2 last updated in 2.47.0
Changes in the **api-trace2** manual
  ...
  17. 2.30.1 → 2.31.8 no changes
  18. [2.30.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2020-12-27_ ](https://git-scm.com/docs/api-trace2/2.30.0)
  19. 2.27.1 → 2.29.3 no changes
  20. [2.27.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2020-06-01_ ](https://git-scm.com/docs/api-trace2/2.27.0)
  21. 2.25.1 → 2.26.3 no changes
  22. 2.25.0 no changes
  23. 2.24.1 → 2.24.4 no changes
...
##  [](https://git-scm.com/docs/api-trace2#_trace2_targets)Trace2 Targets
Trace2 defines the following set of Trace2 Targets. Format details are given in a later section.
###  [](https://git-scm.com/docs/api-trace2#_the_normal_format_target)The Normal Format Target
...
###  [](https://git-scm.com/docs/api-trace2#_the_performance_format_target)The Performance Format Target
...
###  [](https://git-scm.com/docs/api-trace2#_the_event_format_target)The Event Format Target
...
###  [](https://git-scm.com/docs/api-trace2#_enabling_a_target)Enabling a Target
...
##  [](https://git-scm.com/docs/api-trace2#_trace2_api)Trace2 API
...
###  [](https://git-scm.com/docs/api-trace2#_conventions_for_public_functions_and_macros)Conventions for Public Functions and Macros
...
##  [](https://git-scm.com/docs/api-trace2#_trace2_target_formats)Trace2 Target Formats
###  [](https://git-scm.com/docs/api-trace2#_normal_format)NORMAL Format
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-event-name)_< event-name>_

is the event name.

[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-event-message)_< event-message>_
...
###  [](https://git-scm.com/docs/api-trace2#_perf_format)PERF Format
Events are written as lines of the form:
```
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-depth)_< depth>_
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-thread-name)_< thread-name>_
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-event-name-1)_< event-name>_

is the event name.

[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-repo-id)_< repo-id>_
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-tabs)_< t_abs>_

when present, is the absolute time in seconds since the program started.

[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-trel)_< t_rel>_
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-category)_< category>_

is present on region and data events and is used to indicate a broad category, such as "index" or "status".

[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-perf-event-message)_< perf-event-message>_
...
###  [](https://git-scm.com/docs/api-trace2#_event_format)EVENT Format
...
####  [](https://git-scm.com/docs/api-trace2#_common_keyvalue_pairs)Common Key/Value Pairs
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-eventevent)`"event":`_< event>_

is the event name.

[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-sidsid)`"sid":`_< sid>_
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-threadthread)`"thread":`_< thread>_

is the thread name.

[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-timetime)`"time":`_< time>_

is the UTC time of the event.

[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-filefilename)`"file":`_< filename>_

is source file generating the event.

[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-lineline-number)`"line":`_< line-number>_

is the integer source line number generating the event.

[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-reporepo-id)`"repo":`_< repo-id>_
...
####  [](https://git-scm.com/docs/api-trace2#_event_specific_keyvalue_pairs)Event-Specific Key/Value Pairs

[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-version)`"version"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-toomanyfiles)`"too_many_files"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-start)`"start"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-exit)`"exit"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-atexit)`"atexit"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-signal)`"signal"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-error)`"error"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-cmdpath)`"cmd_path"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-cmdancestry)`"cmd_ancestry"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-cmdname)`"cmd_name"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-cmdmode)`"cmd_mode"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-alias)`"alias"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-childstart)`"child_start"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-childexit)`"child_exit"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-childready)`"child_ready"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-exec)`"exec"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-execresult)`"exec_result"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-threadstart)`"thread_start"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-threadexit)`"thread_exit"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-defparam)`"def_param"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-defrepo)`"def_repo"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-regionenter)`"region_enter"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-regionleave)`"region_leave"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-data)`"data"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-data-json)`"data-json"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-thtimer)`"th_timer"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-timer)`"timer"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-thcounter)`"th_counter"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-counter)`"counter"`
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-printf)`"printf"`
...
##  [](https://git-scm.com/docs/api-trace2#_example_trace2_api_usage)Example Trace2 API Usage
Here is a hypothetical usage of the Trace2 API showing the intended usage (without worrying about the actual Git details).

[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-Initialization)Initialization
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-CommandDetails)Command Details
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-ChildProcesses)Child Processes
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-Regions)Regions
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-DataMessages)Data Messages
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-ThreadEvents)Thread Events
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-ConfigdefparamEvents)Config (def param) Events
...
[](https://git-scm.com/docs/api-trace2#Documentation/technical/api-trace2.txt-StopwatchTimerEvents)Stopwatch Timer Events
...
##  [](https://git-scm.com/docs/api-trace2#_future_work)Future Work
###  [](https://git-scm.com/docs/api-trace2#_relationship_to_the_existing_trace_api_api_trace_txt)Relationship to the Existing Trace Api (api-trace.txt)
There are a few issues to resolve before we can completely switch to Trace2.
  * Updating existing tests that assume `GIT_TRACE` format messages.
  * How to best handle custom `GIT_TRACE_`_< key>_ messages?
    * The `GIT_TRACE_`_< key>_ mechanism allows each <key> to write to a different file (in addition to just stderr).
