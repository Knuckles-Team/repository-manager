...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [Importing a new project](https://git-scm.com/docs/gittutorial#_importing_a_new_project)
    * [Making changes](https://git-scm.com/docs/gittutorial#_making_changes)
    * [Git tracks content not files](https://git-scm.com/docs/gittutorial#_git_tracks_content_not_files)
    * [Viewing project history](https://git-scm.com/docs/gittutorial#_viewing_project_history)
    * [Managing branches](https://git-scm.com/docs/gittutorial#_managing_branches)
    * [Using Git for collaboration](https://git-scm.com/docs/gittutorial#_using_git_for_collaboration)
    * [Exploring history](https://git-scm.com/docs/gittutorial#_exploring_history)
    * [Next Steps](https://git-scm.com/docs/gittutorial#_next_steps)
    * [SEE ALSO](https://git-scm.com/docs/gittutorial#_see_also)
    * [GIT](https://git-scm.com/docs/gittutorial#_git)


[ English ▾](https://git-scm.com/docs/gittutorial)
...
[ Latest version ▾ ](https://git-scm.com/docs/gittutorial) gittutorial last updated in 2.46.1
