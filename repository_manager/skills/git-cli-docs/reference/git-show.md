...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    * [NAME](https://git-scm.com/docs/git-show#_name)
    * [SYNOPSIS](https://git-scm.com/docs/git-show#_synopsis)
    * [DESCRIPTION](https://git-scm.com/docs/git-show#_description)
    * [OPTIONS](https://git-scm.com/docs/git-show#_options)
    ...
    * [Generating patch text with -p](https://git-scm.com/docs/git-show#generate_patch_text_with_p)
    * [Combined diff format](https://git-scm.com/docs/git-show#_combined_diff_format)
    * [EXAMPLES](https://git-scm.com/docs/git-show#_examples)
    * [DISCUSSION](https://git-scm.com/docs/git-show#_discussion)
    * [GIT](https://git-scm.com/docs/git-show#_git)


[ English ▾](https://git-scm.com/docs/git-show)
Localized versions of **git-show** manual
  1. [English ](https://git-scm.com/docs/git-show)
  2. [Français ](https://git-scm.com/docs/git-show/fr)
  3. [Português (Brasil) ](https://git-scm.com/docs/git-show/pt_BR)
  4. [Svenska ](https://git-scm.com/docs/git-show/sv)
  5. [українська мова ](https://git-scm.com/docs/git-show/uk)
  6. [简体中文 ](https://git-scm.com/docs/git-show/zh_HANS-CN)

Want to read in your language or fix typos?
[You can help translate this page](https://github.com/jnavila/git-manpages-l10n).
[Topics ▾](https://git-scm.com/docs/git-show)
### Setup and Config
...
[ Latest version ▾ ](https://git-scm.com/docs/git-show) git-show last updated in 2.53.0
Changes in the **git-show** manual
...
`git --version`
##  [](https://git-scm.com/docs/git-show#_name)NAME
git-show - Show various types of objects
##  [](https://git-scm.com/docs/git-show#_synopsis)SYNOPSIS
```
_git show_ [<options>] [<object>…​]
```

##  [](https://git-scm.com/docs/git-show#_description)DESCRIPTION
...
Some options that _git log_ command understands can be used to control how the changes the commit introduces are shown.
This manual page describes only the most frequently used options.
##  [](https://git-scm.com/docs/git-show#_options)OPTIONS

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-object)<object>…​

The names of objects to show (defaults to _HEAD_). For a more complete list of ways to spell object names, see "SPECIFYING REVISIONS" section in [gitrevisions[7]](https://git-scm.com/docs/gitrevisions).

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---prettyformat)`--pretty`[`=`_< format>_]


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---formatformat)`--format=`_< format>_
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---abbrev-commit)`--abbrev-commit`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---no-abbrev-commit)`--no-abbrev-commit`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---oneline)`--oneline`

This is a shorthand for `--pretty=oneline` `--abbrev-commit` used together.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---encodingencoding)`--encoding=`_< encoding>_
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---expand-tabsn)`--expand-tabs=`_< n>_


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---expand-tabs)`--expand-tabs`


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---no-expand-tabs)`--no-expand-tabs`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---notesref)`--notes`[`=`_< ref>_]
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---no-notes)`--no-notes`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---show-notes-by-default)`--show-notes-by-default`

Show the default notes unless options for displaying specific notes are given.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---show-notesref)`--show-notes`[`=`_< ref>_]


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---standard-notes)`--standard-notes`


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---no-standard-notes)`--no-standard-notes`

These options are deprecated. Use the above `--notes`/`--no-notes` options instead.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---show-signature)`--show-signature`

Check the validity of a signed commit object by passing the signature to `gpg` `--verify` and show the output.
##  [](https://git-scm.com/docs/git-show#_pretty_formats)PRETTY FORMATS
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-n)`%n`

newline

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-)`%%`

a raw `%`

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-x00)`%x00`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-Cred)`%Cred`

switch color to red

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-Cgreen)`%Cgreen`

switch color to green

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-Cblue)`%Cblue`

switch color to blue

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-Creset)`%Creset`

reset color

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-Cspec)`%C`(_< spec>_)
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-m)`%m`

left (_<_), right (_>_) or boundary (`-`) mark

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-wwi1i2)`%w`([_< w>_[`,`_< i1>_[`,`_< i2>_]]])

switch line wrapping, like the `-w` option of [git-shortlog[1]](https://git-scm.com/docs/git-shortlog).

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-ntruncltruncmtrunc)_% <(__< n>_[`,`(`trunc`|`ltrunc`|`mtrunc`)])
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-m-1)_% <|(__< m>_ )
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-n-1)_% >(__< n>_)


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-m-1-1)_% >|(__< m>_)

similar to _% <(__< n>_), _% <|(__< m>_) respectively, but padding spaces on the left

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-n-1-1)_% >>(__< n>_)


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-m-1-1-1)_% >>|(__< m>_)
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-n-1-1-1)_% ><(__< n>_)


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-m-1-1-1-1)_% ><|(__< m>_)

similar to _% <(__< n>_), _% <|(__< m>_) respectively, but padding both sides (i.e. the text is centered)
    * Placeholders that expand to information extracted from the commit:

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-H)`%H`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-T)`%T`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-P)`%P`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-an)`%an`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-ae)`%ae`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-al)`%al`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-ad)`%ad`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-ar)`%ar`

author date, relative

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-at)`%at`

author date, UNIX timestamp

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-ai)`%ai`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-as)`%as`

author date, short format (`YYYY-MM-DD`)

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-ah)`%ah`

author date, human style (like the `--date=human` option of [git-rev-list[1]](https://git-scm.com/docs/git-rev-list))

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-cn)`%cn`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-ce)`%ce`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-cl)`%cl`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-cd)`%cd`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-cr)`%cr`

committer date, relative

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-ct)`%ct`

committer date, UNIX timestamp

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-ci)`%ci`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-cs)`%cs`

committer date, short format (`YYYY-MM-DD`)

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-ch)`%ch`

committer date, human style (like the `--date=human` option of [git-rev-list[1]](https://git-scm.com/docs/git-rev-list))

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-d)`%d`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-decorateoption)`%`(`decorate`[`:`_< option>_`,...`])
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-describeoption)`%`(`describe`[`:`_< option>_`,...`])
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-S)`%S`

ref name given on the command line by which the commit was reached (like `git` `log` `--source`), only works with `git` `log`

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-e)`%e`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-f)`%f`

sanitized subject line, suitable for a filename

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-b)`%b`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-GG)`%GG`

raw verification message from GPG for a signed commit

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-G)_%G?_

show "G" for a good (valid) signature, "B" for a bad signature, "U" for a good signature with unknown validity, "X" for a good signature that has expired, "Y" for a good signature made by an expired key, "R" for a good signature made by a revoked key, "E" if the signature cannot be checked (e.g. missing key) and "N" for no signature

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-GS)`%GS`

show the name of the signer for a signed commit

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-GK)`%GK`

show the key used to sign a signed commit

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-GF)`%GF`

show the fingerprint of the key used to sign a signed commit

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-GP)`%GP`

show the fingerprint of the primary key whose subkey was used to sign a signed commit

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-GT)`%GT`

show the trust level for the key used to sign a signed commit

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-gD)`%gD`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-gn)`%gn`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-ge)`%ge`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-trailersoption)`%`(`trailers`[`:`_< option>_`,...`])
...
##  [](https://git-scm.com/docs/git-show#_diff_formatting)DIFF FORMATTING
The options below can be used to change the way `git` `show` generates diff output.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt--p)`-p`


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt--u)`-u`


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---patch)`--patch`

Generate patch (see [Generating patch text with -p](https://git-scm.com/docs/git-show#generate_patch_text_with_p)).

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt--s)`-s`


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---no-patch)`--no-patch`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt--c)`-c`

Produce combined diff output for merge commits. Shortcut for `--diff-merges=combined` `-p`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---cc)`--cc`

Produce dense combined diff output for merge commits. Shortcut for `--diff-merges=dense-combined` `-p`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---dd)`--dd`

Produce diff with respect to first parent for both merge and regular commits. Shortcut for `--diff-merges=first-parent` `-p`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---remerge-diff)`--remerge-diff`

Produce remerge-diff output for merge commits. Shortcut for `--diff-merges=remerge` `-p`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---no-diff-merges)`--no-diff-merges`

Synonym for `--diff-merges=off`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---diff-mergesformat)`--diff-merges=`_< format>_
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-off)`off`


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-none)`none`

Disable output of diffs for merge commits. Useful to override implied value.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-on)`on`


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-m-1-1-1-1-1)`m`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-first-parent)`first-parent`


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-1)`1`

Show full diff with respect to first parent. This is the same format as `--patch` produces for non-merge commits.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-separate)`separate`

Show full diff with respect to each of parents. Separate log entry and diff is generated for each parent.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-combined)`combined`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-dense-combined)`dense-combined`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-remerge)`remerge`


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-r)`r`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---combined-all-paths)`--combined-all-paths`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt--Un)`-U`_< n>_


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---unifiedn)`--unified=`_< n>_

Generate diffs with _< n>_ lines of context instead of the usual three. Implies `--patch`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---outputfile)`--output=`_< file>_

Output to a specific file instead of stdout.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---output-indicator-newchar)`--output-indicator-new=`_< char>_


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---output-indicator-oldchar)`--output-indicator-old=`_< char>_


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---output-indicator-contextchar)`--output-indicator-context=`_< char>_

Specify the character used to indicate new, old or context lines in the generated patch. Normally they are `+`, `-` and ' ' respectively.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---raw)`--raw`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---patch-with-raw)`--patch-with-raw`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---indent-heuristic)`--indent-heuristic`

Enable the heuristic that shifts diff hunk boundaries to make patches easier to read. This is the default.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---no-indent-heuristic)`--no-indent-heuristic`

Disable the indent heuristic.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---minimal)`--minimal`

Spend extra time to make sure the smallest possible diff is produced.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---patience)`--patience`

Generate a diff using the "patience diff" algorithm.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---histogram)`--histogram`

Generate a diff using the "histogram diff" algorithm.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---anchoredtext)`--anchored=`_< text>_
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---diff-algorithmpatienceminimalhistogrammyers)`--diff-algorithm=`(`patience`|`minimal`|`histogram`|`myers`)

Choose a diff algorithm. The variants are as follows:

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-default)`default`


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-myers)`myers`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---statwidthname-widthcount)`--stat`[`=`_< width>_[`,`_< name-width>_[`,`_< count>_]]]
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---compact-summary)`--compact-summary`

Output a condensed summary of extended header information such as file creations or deletions ("new" or "gone", optionally `+l` if it's a symlink) and mode changes (`+x` or `-x` for adding or removing executable bit respectively) in diffstat. The information is put between the filename part and the graph part. Implies `--stat`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---numstat)`--numstat`

Similar to `--stat`, but shows number of added and deleted lines in decimal notation and pathname without abbreviation, to make it more machine friendly. For binary files, outputs two `-` instead of saying `0` `0`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---shortstat)`--shortstat`

Output only the last line of the `--stat` format containing total number of modified files, as well as number of added and deleted lines.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt--Xparam)`-X` [_< param>_`,...`]


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---dirstatparam)`--dirstat`[`=`_< param>_`,...`]
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-changes)`changes`

Compute the dirstat numbers by counting the lines that have been removed from the source, or added to the destination. This ignores the amount of pure code movements within a file. In other words, rearranging lines in a file is not counted as much as other changes. This is the default behavior when no parameter is given.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-lines)`lines`

Compute the dirstat numbers by doing the regular line-based diff analysis, and summing the removed/added line counts. (For binary files, count 64-byte chunks instead, since binary files have no natural concept of lines). This is a more expensive `--dirstat` behavior than the `changes` behavior, but it does count rearranged lines within a file as much as other changes. The resulting output is consistent with what you get from the other `--*stat` options.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-files)`files`

Compute the dirstat numbers by counting the number of files changed. Each changed file counts equally in the dirstat analysis. This is the computationally cheapest `--dirstat` behavior, since it does not have to look at the file contents at all.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-cumulative)`cumulative`

Count changes in a child directory for the parent directory as well. Note that when using `cumulative`, the sum of the percentages reported may exceed 100%. The default (non-cumulative) behavior can be specified with the `noncumulative` parameter.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-limit)_< limit>_
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---dirstat-by-fileparam)`--dirstat-by-file`[`=`_< param>_`,...`]

Synonym for `--dirstat=files,`_< param>_`,...`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---summary)`--summary`

Output a condensed summary of extended header information such as creations, renames and mode changes.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---patch-with-stat)`--patch-with-stat`

Synonym for `-p` `--stat`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt--z)`-z`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---name-only)`--name-only`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---name-status)`--name-status`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---submoduleformat)`--submodule`[`=`_< format>_]
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---colorwhen)`--color`[`=`_< when>_]

Show colored diff. `--color` (i.e. without `=`_< when>_) is the same as `--color=always`. _< when>_ can be one of `always`, `never`, or `auto`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---no-color)`--no-color`

Turn off colored diff. It is the same as `--color=never`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---color-movedmode)`--color-moved`[`=`_< mode>_]
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-no)`no`

Moved lines are not highlighted.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-default-1)`default`

Is a synonym for `zebra`. This may change to a more sensible mode in the future.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-plain)`plain`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-blocks)`blocks`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-zebra)`zebra`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-dimmed-zebra)`dimmed-zebra`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---no-color-moved)`--no-color-moved`

Turn off move detection. This can be used to override configuration settings. It is the same as `--color-moved=no`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---color-moved-wsmode)`--color-moved-ws=`_< mode>_`,...`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-no-1)`no`

Do not ignore whitespace when performing move detection.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-ignore-space-at-eol)`ignore-space-at-eol`

Ignore changes in whitespace at EOL.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-ignore-space-change)`ignore-space-change`

Ignore changes in amount of whitespace. This ignores whitespace at line end, and considers all other sequences of one or more whitespace characters to be equivalent.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-ignore-all-space)`ignore-all-space`

Ignore whitespace when comparing lines. This ignores differences even if one line has whitespace where the other line has none.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-allow-indentation-change)`allow-indentation-change`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---no-color-moved-ws)`--no-color-moved-ws`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---word-diffmode)`--word-diff`[`=`_< mode>_]

By default, words are delimited by whitespace; see `--word-diff-regex` below. The _< mode>_ defaults to `plain`, and must be one of:

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-color)`color`

Highlight changed words using only colors. Implies `--color`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-plain-1)`plain`

Show words as [`-removed-`] and `{`added`}`. Makes no attempts to escape the delimiters if they appear in the input, so the output may be ambiguous.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-porcelain)`porcelain`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-none-1)`none`

Disable word diff again.
Note that despite the name of the first mode, color is used to highlight the changed parts in all modes if enabled.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---word-diff-regexregex)`--word-diff-regex=`_< regex>_
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---color-wordsregex)`--color-words`[`=`_< regex>_]

Equivalent to `--word-diff=color` plus (if a regex was specified) `--word-diff-regex=`_< regex>_.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---no-renames)`--no-renames`

Turn off rename detection, even when the configuration file gives the default to do so.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---rename-empty)`--rename-empty`


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---no-rename-empty)`--no-rename-empty`

Whether to use empty blobs as rename source.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---check)`--check`

Warn if changes introduce conflict markers or whitespace errors. What are considered whitespace errors is controlled by `core.whitespace` configuration. By default, trailing whitespaces (including lines that consist solely of whitespaces) and a space character that is immediately followed by a tab character inside the initial indent of the line are considered whitespace errors. Exits with non-zero status if problems are found. Not compatible with `--exit-code`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---ws-error-highlightkind)`--ws-error-highlight=`_< kind>_

Highlight whitespace errors in the `context`, `old` or `new` lines of the diff. Multiple values are separated by comma, `none` resets previous values, `default` reset the list to `new` and `all` is a shorthand for `old,new,context`. When this option is not given, and the configuration variable `diff.wsErrorHighlight` is not set, only whitespace errors in `new` lines are highlighted. The whitespace errors are colored with `color.diff.whitespace`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---full-index)`--full-index`

Instead of the first handful of characters, show the full pre- and post-image blob object names on the "index" line when generating patch format output.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---binary)`--binary`

In addition to `--full-index`, output a binary diff that can be applied with `git-apply`. Implies `--patch`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---abbrevn)`--abbrev`[`=`_< n>_]
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt--Bnm)`-B`[_< n>_][`/`_< m>_]


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---break-rewritesnm)`--break-rewrites`[`=`[_< n>_][`/`_< m>_]]
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt--Mn)`-M`[_< n>_]


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---find-renamesn)`--find-renames`[`=`_< n>_]
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt--Cn)`-C`[_< n>_]


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---find-copiesn)`--find-copies`[`=`_< n>_]
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---find-copies-harder)`--find-copies-harder`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---irreversible-delete)`--irreversible-delete`

Omit the preimage for deletes, i.e. print only the header but not the diff between the preimage and `/dev/null`. The resulting patch is not meant to be applied with `patch` or `git` `apply`; this is solely for people who want to just concentrate on reviewing the text after the change. In addition, the output obviously lacks enough information to apply such a patch in reverse, even manually, hence the name of the option.
When used together with `-B`, omit also the preimage in the deletion part of a delete/create pair.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt--lnum)`-l`_< num>_
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---diff-filterACDMRTUXB)`--diff-filter=`[(`A`|`C`|`D`|`M`|`R`|`T`|`U`|`X`|`B`)`...`[`*`]]
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt--Sstring)`-S`_< string>_
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt--Gregex)`-G`_< regex>_
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---find-objectobject-id)`--find-object=`_< object-id>_
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---pickaxe-all)`--pickaxe-all`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---pickaxe-regex)`--pickaxe-regex`

Treat the _< string>_ given to `-S` as an extended POSIX regular expression to match.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt--Oorderfile)`-O`_< orderfile>_
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---skip-tofile)`--skip-to=`_< file>_


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---rotate-tofile)`--rotate-to=`_< file>_
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---relativepath)`--relative`[`=`_< path>_]


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---no-relative)`--no-relative`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt--a)`-a`


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---text)`--text`

Treat all files as text.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---ignore-cr-at-eol)`--ignore-cr-at-eol`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt--w)`-w`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---ignore-blank-lines)`--ignore-blank-lines`

Ignore changes whose lines are all blank.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt--Iregex)`-I`_< regex>_


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---ignore-matching-linesregex)`--ignore-matching-lines=`_< regex>_

Ignore changes whose all lines match _< regex>_. This option may be specified more than once.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---inter-hunk-contextnumber)`--inter-hunk-context=`_< number>_
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---function-context)`--function-context`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---ext-diff)`--ext-diff`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---no-ext-diff)`--no-ext-diff`

Disallow external diff drivers.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---textconv)`--textconv`


[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---no-textconv)`--no-textconv`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---ignore-submodulesnoneuntrackeddirtyall)`--ignore-submodules`[`=`(`none`|`untracked`|`dirty`|`all`)]
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---src-prefixprefix)`--src-prefix=`_< prefix>_

Show the given source _< prefix>_ instead of "a/".

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---dst-prefixprefix)`--dst-prefix=`_< prefix>_

Show the given destination _< prefix>_ instead of "b/".

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---no-prefix)`--no-prefix`

Do not show any source or destination prefix.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---default-prefix)`--default-prefix`
...
[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---line-prefixprefix)`--line-prefix=`_< prefix>_

Prepend an additional _< prefix>_ to every line of output.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---ita-invisible-in-index)`--ita-invisible-in-index`

By default entries added by `git` `add` `-N` appear as an existing empty file in `git` `diff` and a new file in `git` `diff` `--cached`. This option makes the entry appear as a new file in `git` `diff` and non-existent in `git` `diff` `--cached`. This option could be reverted with `--ita-visible-in-index`. Both options are experimental and could be removed in future.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt---max-depthdepth)--max-depth=<depth>
...
##  [](https://git-scm.com/docs/git-show#generate_patch_text_with_p)Generating patch text with -p
...
##  [](https://git-scm.com/docs/git-show#_combined_diff_format)Combined diff format
...
##  [](https://git-scm.com/docs/git-show#_examples)EXAMPLES

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-gitshowv100)`git` `show` `v1.0.0`

Shows the tag `v1.0.0`, along with the object the tag points at.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-gitshowv100tree)`git` `show` `v1.0.0^{tree}`

Shows the tree pointed to by the tag `v1.0.0`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-gitshow-s--formatsv100commit)`git` `show` `-s` `--format=%s` `v1.0.0^{commit}`

Shows the subject of the commit pointed to by the tag `v1.0.0`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-gitshownext10DocumentationREADME)`git` `show` `next~10:Documentation/README`

Shows the contents of the file `Documentation/README` as they were current in the 10th last commit of the branch `next`.

[](https://git-scm.com/docs/git-show#Documentation/git-show.txt-gitshowmasterMakefilemastertMakefile)`git` `show` `master:Makefile` `master:t/Makefile`

Concatenates the contents of said Makefiles in the head of the branch `master`.
##  [](https://git-scm.com/docs/git-show#_discussion)DISCUSSION
...
##  [](https://git-scm.com/docs/git-show#_git)GIT
