...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [OPTIONS](https://git-scm.com/docs/git/2.35.0#_options)
    * [GIT COMMANDS](https://git-scm.com/docs/git/2.35.0#_git_commands)
    * [High-level commands (porcelain)](https://git-scm.com/docs/git/2.35.0#_high_level_commands_porcelain)
    * [Low-level commands (plumbing)](https://git-scm.com/docs/git/2.35.0#_low_level_commands_plumbing)
    * [Guides](https://git-scm.com/docs/git/2.35.0#_guides)
    * [Configuration Mechanism](https://git-scm.com/docs/git/2.35.0#_configuration_mechanism)
    * [Identifier Terminology](https://git-scm.com/docs/git/2.35.0#_identifier_terminology)
    * [Symbolic Identifiers](https://git-scm.com/docs/git/2.35.0#_symbolic_identifiers)
    * [File/Directory Structure](https://git-scm.com/docs/git/2.35.0#_filedirectory_structure)
    * [Terminology](https://git-scm.com/docs/git/2.35.0#_terminology)
    * [Environment Variables](https://git-scm.com/docs/git/2.35.0#_environment_variables)
    * [Discussion](https://git-scm.com/docs/git/2.35.0#_discussion)
    * [FURTHER DOCUMENTATION](https://git-scm.com/docs/git/2.35.0#_further_documentation)
    * [Authors](https://git-scm.com/docs/git/2.35.0#_authors)
    * [Reporting Bugs](https://git-scm.com/docs/git/2.35.0#_reporting_bugs)
    * [SEE ALSO](https://git-scm.com/docs/git/2.35.0#_see_also)
    * [GIT](https://git-scm.com/docs/git/2.35.0#_git)


[ English ▾](https://git-scm.com/docs/git/2.35.0)
...
[ Version 2.35.0 ▾ ](https://git-scm.com/docs/git/2.35.0) git last updated in 2.53.0
...
`git --version`
##  [](https://git-scm.com/docs/git/2.35.0#_name)NAME
git - the stupid content tracker
##  [](https://git-scm.com/docs/git/2.35.0#_synopsis)SYNOPSIS
```
...
##  [](https://git-scm.com/docs/git/2.35.0#_description)DESCRIPTION
...
##  [](https://git-scm.com/docs/git/2.35.0#_low_level_commands_plumbing)Low-level commands (plumbing)
...
##  [](https://git-scm.com/docs/git/2.35.0#_terminology)Terminology
...
##  [](https://git-scm.com/docs/git/2.35.0#_further_documentation)FURTHER DOCUMENTATION
...
##  [](https://git-scm.com/docs/git/2.35.0#_authors)Authors
...
##  [](https://git-scm.com/docs/git/2.35.0#_reporting_bugs)Reporting Bugs
...
##  [](https://git-scm.com/docs/git/2.35.0#_see_also)SEE ALSO
