...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [OPTIONS](https://git-scm.com/docs/git-clone#_options)
    * [GIT URLS](https://git-scm.com/docs/git-clone#_git_urls)
    * [EXAMPLES](https://git-scm.com/docs/git-clone#_examples)
    * [CONFIGURATION](https://git-scm.com/docs/git-clone#_configuration)
    * [GIT](https://git-scm.com/docs/git-clone#_git)


[ English ▾](https://git-scm.com/docs/git-clone)
Localized versions of **git-clone** manual
  1. [English ](https://git-scm.com/docs/git-clone)
  2. [Deutsch ](https://git-scm.com/docs/git-clone/de)
  3. [Español ](https://git-scm.com/docs/git-clone/es)
  4. [Français ](https://git-scm.com/docs/git-clone/fr)
  5. [Íslenska ](https://git-scm.com/docs/git-clone/is)
  6. [日本語 ](https://git-scm.com/docs/git-clone/ja)
  7. [Português (Brasil) ](https://git-scm.com/docs/git-clone/pt_BR)
  8. [Română ](https://git-scm.com/docs/git-clone/ro)
  9. [Русский ](https://git-scm.com/docs/git-clone/ru)
  10. [Svenska ](https://git-scm.com/docs/git-clone/sv)
...
[ Latest version ▾ ](https://git-scm.com/docs/git-clone) git-clone last updated in 2.52.0
Changes in the **git-clone** manual
  ...
  54. 2.12.5 no changes
  55. [2.11.4 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2017-09-22_ ](https://git-scm.com/docs/git-clone/2.11.4)
  56. 2.10.5 no changes
  57. [2.9.5 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2017-07-30_ ](https://git-scm.com/docs/git-clone/2.9.5)
  58. [2.8.6 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2017-07-30_ ](https://git-scm.com/docs/git-clone/2.8.6)
  59. [2.7.6 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2017-07-30_ ](https://git-scm.com/docs/git-clone/2.7.6)
  60. 2.4.12 → 2.6.7 no changes
  61. [2.3.10 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2015-09-28_ ](https://git-scm.com/docs/git-clone/2.3.10)
  62. 2.1.4 → 2.2.3 no changes
  63. [2.0.5 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2014-12-17_ ](https://git-scm.com/docs/git-clone/2.0.5)


Check your version of git by running
`git --version`
##  [](https://git-scm.com/docs/git-clone#_name)NAME
git-clone - Clone a repository into a new directory
##  [](https://git-scm.com/docs/git-clone#_synopsis)SYNOPSIS
```
git clone [--template=_<template-directory>_]
	  [-l] [-s] [--no-hardlinks] [-q] [-n] [--bare] [--mirror]
	  [-o _<name>_] [-b _<name>_] [-u _<upload-pack>_] [--reference _<repository>_]
	  [--dissociate] [--separate-git-dir _<git-dir>_]
	  [--depth _<depth>_] [--[no-]single-branch] [--[no-]tags]
	  [--recurse-submodules[=_<pathspec>_]] [--[no-]shallow-submodules]
	  [--[no-]remote-submodules] [--jobs _<n>_] [--sparse] [--[no-]reject-shallow]
	  [--filter=_<filter-spec>_ [--also-filter-submodules]] [--] _<repository>_
	  [_<directory>_]
```

##  [](https://git-scm.com/docs/git-clone#_description)DESCRIPTION
...
##  [](https://git-scm.com/docs/git-clone#_examples)EXAMPLES
  * Clone from upstream:
```
