...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    * [NAME](https://git-scm.com/docs/git-diff-index#_name)
    * [SYNOPSIS](https://git-scm.com/docs/git-diff-index#_synopsis)
    * [DESCRIPTION](https://git-scm.com/docs/git-diff-index#_description)
    * [OPTIONS](https://git-scm.com/docs/git-diff-index#_options)
    * [Raw output format](https://git-scm.com/docs/git-diff-index#_raw_output_format)
    * [diff format for merges](https://git-scm.com/docs/git-diff-index#_diff_format_for_merges)
    * [Generating patch text with -p](https://git-scm.com/docs/git-diff-index#generate_patch_text_with_p)
    * [Combined diff format](https://git-scm.com/docs/git-diff-index#_combined_diff_format)
    * [other diff formats](https://git-scm.com/docs/git-diff-index#_other_diff_formats)
    * [OPERATING MODES](https://git-scm.com/docs/git-diff-index#_operating_modes)
    * [CACHED MODE](https://git-scm.com/docs/git-diff-index#_cached_mode)
    * [NON-CACHED MODE](https://git-scm.com/docs/git-diff-index#_non_cached_mode)
    * [GIT](https://git-scm.com/docs/git-diff-index#_git)


[ English ▾](https://git-scm.com/docs/git-diff-index)
Localized versions of **git-diff-index** manual
  1. [English ](https://git-scm.com/docs/git-diff-index)
  2. [Português (Brasil) ](https://git-scm.com/docs/git-diff-index/pt_BR)
  3. [Русский ](https://git-scm.com/docs/git-diff-index/ru)
  4. [Svenska ](https://git-scm.com/docs/git-diff-index/sv)
  5. [українська мова ](https://git-scm.com/docs/git-diff-index/uk)
  6. [简体中文 ](https://git-scm.com/docs/git-diff-index/zh_HANS-CN)

Want to read in your language or fix typos?
[You can help translate this page](https://github.com/jnavila/git-manpages-l10n).
[Topics ▾](https://git-scm.com/docs/git-diff-index)
### Setup and Config
...
[ Latest version ▾ ](https://git-scm.com/docs/git-diff-index) git-diff-index last updated in 2.53.0
Changes in the **git-diff-index** manual
  ...
  24. 2.37.3 → 2.39.5 no changes
  25. [2.37.2 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2022-08-11_ ](https://git-scm.com/docs/git-diff-index/2.37.2)
  26. 2.36.1 → 2.37.1 no changes
  27. [2.36.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2022-04-18_ ](https://git-scm.com/docs/git-diff-index/2.36.0)
  28. 2.35.1 → 2.35.8 no changes
  29. [2.35.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2022-01-24_ ](https://git-scm.com/docs/git-diff-index/2.35.0)
  30. 2.34.1 → 2.34.8 no changes
  31. [2.34.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2021-11-15_ ](https://git-scm.com/docs/git-diff-index/2.34.0)
  32. 2.33.1 → 2.33.8 no changes
  33. [2.33.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2021-08-16_ ](https://git-scm.com/docs/git-diff-index/2.33.0)
  34. 2.32.1 → 2.32.7 no changes
  35. [2.32.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2021-06-06_ ](https://git-scm.com/docs/git-diff-index/2.32.0)
  36. 2.31.1 → 2.31.8 no changes
  37. [2.31.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2021-03-15_ ](https://git-scm.com/docs/git-diff-index/2.31.0)
  38. 2.30.1 → 2.30.9 no changes
  39. [2.30.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2020-12-27_ ](https://git-scm.com/docs/git-diff-index/2.30.0)
  40. 2.29.1 → 2.29.3 no changes
  41. [2.29.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2020-10-19_ ](https://git-scm.com/docs/git-diff-index/2.29.0)
  42. 2.28.1 no changes
  43. [2.28.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2020-07-27_ ](https://git-scm.com/docs/git-diff-index/2.28.0)
  44. 2.25.2 → 2.27.1 no changes
  45. [2.25.1 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2020-02-17_ ](https://git-scm.com/docs/git-diff-index/2.25.1)
  46. [2.25.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2020-01-13_ ](https://git-scm.com/docs/git-diff-index/2.25.0)
  47. 2.24.1 → 2.24.4 no changes
  48. [2.24.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2019-11-04_ ](https://git-scm.com/docs/git-diff-index/2.24.0)
  49. 2.22.1 → 2.23.4 no changes
  50. [2.22.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2019-06-07_ ](https://git-scm.com/docs/git-diff-index/2.22.0)
  51. 2.21.1 → 2.21.4 no changes
  52. [2.21.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2019-02-24_ ](https://git-scm.com/docs/git-diff-index/2.21.0)
  53. 2.20.1 → 2.20.5 no changes
  54. [2.20.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2018-12-09_ ](https://git-scm.com/docs/git-diff-index/2.20.0)
  55. 2.19.1 → 2.19.6 no changes
  56. [2.19.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2018-09-10_ ](https://git-scm.com/docs/git-diff-index/2.19.0)
  57. 2.18.1 → 2.18.5 no changes
  58. [2.18.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2018-06-21_ ](https://git-scm.com/docs/git-diff-index/2.18.0)
  59. 2.17.1 → 2.17.6 no changes
  60. [2.17.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2018-04-02_ ](https://git-scm.com/docs/git-diff-index/2.17.0)
  61. [2.16.6 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2019-12-06_ ](https://git-scm.com/docs/git-diff-index/2.16.6)
  62. [2.15.4 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2019-12-06_ ](https://git-scm.com/docs/git-diff-index/2.15.4)
  63. [2.14.6 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2019-12-06_ ](https://git-scm.com/docs/git-diff-index/2.14.6)
  64. [2.13.7 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2018-05-22_ ](https://git-scm.com/docs/git-diff-index/2.13.7)
  65. [2.12.5 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2017-09-22_ ](https://git-scm.com/docs/git-diff-index/2.12.5)
  66. [2.11.4 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2017-09-22_ ](https://git-scm.com/docs/git-diff-index/2.11.4)
  67. 2.10.5 no changes
  68. [2.9.5 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2017-07-30_ ](https://git-scm.com/docs/git-diff-index/2.9.5)
  69. [2.8.6 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2017-07-30_ ](https://git-scm.com/docs/git-diff-index/2.8.6)
  70. 2.7.6 no changes
  71. [2.6.7 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2017-05-05_ ](https://git-scm.com/docs/git-diff-index/2.6.7)
  72. [2.5.6 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2017-05-05_ ](https://git-scm.com/docs/git-diff-index/2.5.6)
  73. [2.4.12 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2017-05-05_ ](https://git-scm.com/docs/git-diff-index/2.4.12)
  74. [2.3.10 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2015-09-28_ ](https://git-scm.com/docs/git-diff-index/2.3.10)
  75. 2.1.4 → 2.2.3 no changes
  76. [2.0.5 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2014-12-17_ ](https://git-scm.com/docs/git-diff-index/2.0.5)


Check your version of git by running
`git --version`
##  [](https://git-scm.com/docs/git-diff-index#_name)NAME
git-diff-index - Compare a tree to the working tree or index
##  [](https://git-scm.com/docs/git-diff-index#_synopsis)SYNOPSIS
```
_git diff-index_ [-m] [--cached] [--merge-base] [<common-diff-options>] <tree-ish> [<path>…​]
```

##  [](https://git-scm.com/docs/git-diff-index#_description)DESCRIPTION
...
##  [](https://git-scm.com/docs/git-diff-index#_options)OPTIONS

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--p)`-p`


[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--u)`-u`


[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---patch)`--patch`

Generate patch (see [Generating patch text with -p](https://git-scm.com/docs/git-diff-index#generate_patch_text_with_p)).

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--s)`-s`


[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---no-patch)`--no-patch`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--Un)`-U`_< n>_


[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---unifiedn)`--unified=`_< n>_

Generate diffs with _< n>_ lines of context instead of the usual three. Implies `--patch`.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---outputfile)`--output=`_< file>_

Output to a specific file instead of stdout.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---output-indicator-newchar)`--output-indicator-new=`_< char>_


[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---output-indicator-oldchar)`--output-indicator-old=`_< char>_


[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---output-indicator-contextchar)`--output-indicator-context=`_< char>_

Specify the character used to indicate new, old or context lines in the generated patch. Normally they are `+`, `-` and ' ' respectively.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---raw)`--raw`

Generate the diff in raw format. This is the default.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---patch-with-raw)`--patch-with-raw`

Synonym for `-p` `--raw`.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---indent-heuristic)`--indent-heuristic`

Enable the heuristic that shifts diff hunk boundaries to make patches easier to read. This is the default.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---no-indent-heuristic)`--no-indent-heuristic`

Disable the indent heuristic.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---minimal)`--minimal`

Spend extra time to make sure the smallest possible diff is produced.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---patience)`--patience`

Generate a diff using the "patience diff" algorithm.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---histogram)`--histogram`

Generate a diff using the "histogram diff" algorithm.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---anchoredtext)`--anchored=`_< text>_
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---diff-algorithmpatienceminimalhistogrammyers)`--diff-algorithm=`(`patience`|`minimal`|`histogram`|`myers`)

Choose a diff algorithm. The variants are as follows:

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-default)`default`


[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-myers)`myers`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---statwidthname-widthcount)`--stat`[`=`_< width>_[`,`_< name-width>_[`,`_< count>_]]]
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---compact-summary)`--compact-summary`

Output a condensed summary of extended header information such as file creations or deletions ("new" or "gone", optionally `+l` if it's a symlink) and mode changes (`+x` or `-x` for adding or removing executable bit respectively) in diffstat. The information is put between the filename part and the graph part. Implies `--stat`.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---numstat)`--numstat`

Similar to `--stat`, but shows number of added and deleted lines in decimal notation and pathname without abbreviation, to make it more machine friendly. For binary files, outputs two `-` instead of saying `0` `0`.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---shortstat)`--shortstat`

Output only the last line of the `--stat` format containing total number of modified files, as well as number of added and deleted lines.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--Xparam)`-X` [_< param>_`,...`]


[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---dirstatparam)`--dirstat`[`=`_< param>_`,...`]
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-changes)`changes`

Compute the dirstat numbers by counting the lines that have been removed from the source, or added to the destination. This ignores the amount of pure code movements within a file. In other words, rearranging lines in a file is not counted as much as other changes. This is the default behavior when no parameter is given.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-lines)`lines`

Compute the dirstat numbers by doing the regular line-based diff analysis, and summing the removed/added line counts. (For binary files, count 64-byte chunks instead, since binary files have no natural concept of lines). This is a more expensive `--dirstat` behavior than the `changes` behavior, but it does count rearranged lines within a file as much as other changes. The resulting output is consistent with what you get from the other `--*stat` options.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-files)`files`

Compute the dirstat numbers by counting the number of files changed. Each changed file counts equally in the dirstat analysis. This is the computationally cheapest `--dirstat` behavior, since it does not have to look at the file contents at all.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-cumulative)`cumulative`

Count changes in a child directory for the parent directory as well. Note that when using `cumulative`, the sum of the percentages reported may exceed 100%. The default (non-cumulative) behavior can be specified with the `noncumulative` parameter.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-limit)_< limit>_
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---dirstat-by-fileparam)`--dirstat-by-file`[`=`_< param>_`,...`]

Synonym for `--dirstat=files,`_< param>_`,...`.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---summary)`--summary`

Output a condensed summary of extended header information such as creations, renames and mode changes.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---patch-with-stat)`--patch-with-stat`

Synonym for `-p` `--stat`.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--z)`-z`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---name-only)`--name-only`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---name-status)`--name-status`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---submoduleformat)`--submodule`[`=`_< format>_]
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---colorwhen)`--color`[`=`_< when>_]

Show colored diff. `--color` (i.e. without `=`_< when>_) is the same as `--color=always`. _< when>_ can be one of `always`, `never`, or `auto`.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---no-color)`--no-color`

Turn off colored diff. It is the same as `--color=never`.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---color-movedmode)`--color-moved`[`=`_< mode>_]
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-no)`no`

Moved lines are not highlighted.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-default-1)`default`

Is a synonym for `zebra`. This may change to a more sensible mode in the future.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-plain)`plain`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-blocks)`blocks`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-zebra)`zebra`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-dimmed-zebra)`dimmed-zebra`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---no-color-moved)`--no-color-moved`

Turn off move detection. This can be used to override configuration settings. It is the same as `--color-moved=no`.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---color-moved-wsmode)`--color-moved-ws=`_< mode>_`,...`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-no-1)`no`

Do not ignore whitespace when performing move detection.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-ignore-space-at-eol)`ignore-space-at-eol`

Ignore changes in whitespace at EOL.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-ignore-space-change)`ignore-space-change`

Ignore changes in amount of whitespace. This ignores whitespace at line end, and considers all other sequences of one or more whitespace characters to be equivalent.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-ignore-all-space)`ignore-all-space`

Ignore whitespace when comparing lines. This ignores differences even if one line has whitespace where the other line has none.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-allow-indentation-change)`allow-indentation-change`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---no-color-moved-ws)`--no-color-moved-ws`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---word-diffmode)`--word-diff`[`=`_< mode>_]

By default, words are delimited by whitespace; see `--word-diff-regex` below. The _< mode>_ defaults to `plain`, and must be one of:

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-color)`color`

Highlight changed words using only colors. Implies `--color`.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-plain-1)`plain`

Show words as [`-removed-`] and `{`added`}`. Makes no attempts to escape the delimiters if they appear in the input, so the output may be ambiguous.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-porcelain)`porcelain`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-none)`none`

Disable word diff again.
Note that despite the name of the first mode, color is used to highlight the changed parts in all modes if enabled.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---word-diff-regexregex)`--word-diff-regex=`_< regex>_
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---color-wordsregex)`--color-words`[`=`_< regex>_]

Equivalent to `--word-diff=color` plus (if a regex was specified) `--word-diff-regex=`_< regex>_.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---no-renames)`--no-renames`

Turn off rename detection, even when the configuration file gives the default to do so.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---rename-empty)`--rename-empty`


[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---no-rename-empty)`--no-rename-empty`

Whether to use empty blobs as rename source.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---check)`--check`

Warn if changes introduce conflict markers or whitespace errors. What are considered whitespace errors is controlled by `core.whitespace` configuration. By default, trailing whitespaces (including lines that consist solely of whitespaces) and a space character that is immediately followed by a tab character inside the initial indent of the line are considered whitespace errors. Exits with non-zero status if problems are found. Not compatible with `--exit-code`.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---ws-error-highlightkind)`--ws-error-highlight=`_< kind>_

Highlight whitespace errors in the `context`, `old` or `new` lines of the diff. Multiple values are separated by comma, `none` resets previous values, `default` reset the list to `new` and `all` is a shorthand for `old,new,context`. When this option is not given, and the configuration variable `diff.wsErrorHighlight` is not set, only whitespace errors in `new` lines are highlighted. The whitespace errors are colored with `color.diff.whitespace`.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---full-index)`--full-index`

Instead of the first handful of characters, show the full pre- and post-image blob object names on the "index" line when generating patch format output.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---binary)`--binary`

In addition to `--full-index`, output a binary diff that can be applied with `git-apply`. Implies `--patch`.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---abbrevn)`--abbrev`[`=`_< n>_]
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--Bnm)`-B`[_< n>_][`/`_< m>_]


[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---break-rewritesnm)`--break-rewrites`[`=`[_< n>_][`/`_< m>_]]
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--Mn)`-M`[_< n>_]


[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---find-renamesn)`--find-renames`[`=`_< n>_]
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--Cn)`-C`[_< n>_]


[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---find-copiesn)`--find-copies`[`=`_< n>_]
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---find-copies-harder)`--find-copies-harder`

For performance reasons, by default, `-C` option finds copies only if the original file of the copy was modified in the same changeset. This flag makes the command inspect unmodified files as candidates for the source of copy. This is a very expensive operation for large projects, so use it with caution. Giving more than one `-C` option has the same effect.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--D)`-D`


[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---irreversible-delete)`--irreversible-delete`

Omit the preimage for deletes, i.e. print only the header but not the diff between the preimage and `/dev/null`. The resulting patch is not meant to be applied with `patch` or `git` `apply`; this is solely for people who want to just concentrate on reviewing the text after the change. In addition, the output obviously lacks enough information to apply such a patch in reverse, even manually, hence the name of the option.
When used together with `-B`, omit also the preimage in the deletion part of a delete/create pair.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--lnum)`-l`_< num>_
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---diff-filterACDMRTUXB)`--diff-filter=`[(`A`|`C`|`D`|`M`|`R`|`T`|`U`|`X`|`B`)`...`[`*`]]
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--Sstring)`-S`_< string>_
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--Gregex)`-G`_< regex>_
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---find-objectobject-id)`--find-object=`_< object-id>_
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---pickaxe-all)`--pickaxe-all`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---pickaxe-regex)`--pickaxe-regex`

Treat the _< string>_ given to `-S` as an extended POSIX regular expression to match.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--Oorderfile)`-O`_< orderfile>_
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---skip-tofile)`--skip-to=`_< file>_


[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---rotate-tofile)`--rotate-to=`_< file>_
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--R)`-R`

Swap two inputs; that is, show differences from index or on-disk file to tree contents.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---relativepath)`--relative`[`=`_< path>_]


[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---no-relative)`--no-relative`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--a)`-a`


[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---text)`--text`

Treat all files as text.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---ignore-cr-at-eol)`--ignore-cr-at-eol`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--b)`-b`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--w)`-w`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---ignore-blank-lines)`--ignore-blank-lines`

Ignore changes whose lines are all blank.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--Iregex)`-I`_< regex>_


[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---ignore-matching-linesregex)`--ignore-matching-lines=`_< regex>_

Ignore changes whose all lines match _< regex>_. This option may be specified more than once.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---inter-hunk-contextnumber)`--inter-hunk-context=`_< number>_
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---function-context)`--function-context`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---exit-code)`--exit-code`

Make the program exit with codes similar to `diff`(1). That is, it exits with 1 if there were differences and 0 means no differences.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---quiet)`--quiet`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---ext-diff)`--ext-diff`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---no-ext-diff)`--no-ext-diff`

Disallow external diff drivers.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---textconv)`--textconv`


[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---no-textconv)`--no-textconv`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---ignore-submodulesnoneuntrackeddirtyall)`--ignore-submodules`[`=`(`none`|`untracked`|`dirty`|`all`)]
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---src-prefixprefix)`--src-prefix=`_< prefix>_

Show the given source _< prefix>_ instead of "a/".

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---dst-prefixprefix)`--dst-prefix=`_< prefix>_

Show the given destination _< prefix>_ instead of "b/".

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---no-prefix)`--no-prefix`

Do not show any source or destination prefix.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---default-prefix)`--default-prefix`
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---line-prefixprefix)`--line-prefix=`_< prefix>_

Prepend an additional _< prefix>_ to every line of output.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---ita-invisible-in-index)`--ita-invisible-in-index`

By default entries added by `git` `add` `-N` appear as an existing empty file in `git` `diff` and a new file in `git` `diff` `--cached`. This option makes the entry appear as a new file in `git` `diff` and non-existent in `git` `diff` `--cached`. This option could be reverted with `--ita-visible-in-index`. Both options are experimental and could be removed in future.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---max-depthdepth)--max-depth=<depth>
...
[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-tree-ish)<tree-ish>

The id of a tree object to diff against.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---cached)--cached

Do not consider the on-disk file at all.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt---merge-base)--merge-base

Instead of comparing <tree-ish> directly, use the merge base between <tree-ish> and HEAD instead. <tree-ish> must be a commit.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt--m)-m
...
##  [](https://git-scm.com/docs/git-diff-index#_raw_output_format)Raw output format
The raw output format from `git-diff-index`, `git-diff-tree`, `git-diff-files` and `git` `diff` `--raw` are very similar.
These commands all compare two sets of things; what is compared differs:

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-git-diff-indextree-ish)`git-diff-index` _< tree-ish>_

compares the _< tree-ish>_ and the files on the filesystem.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-git-diff-index--cachedtree-ish)`git-diff-index` `--cached` _< tree-ish>_

compares the _< tree-ish>_ and the index.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-git-diff-tree-rtree-ish-1tree-ish-2pattern)`git-diff-tree` [`-r`] _< tree-ish-1>_ _< tree-ish-2>_ [_< pattern>_...]

compares the trees named by the two arguments.

[](https://git-scm.com/docs/git-diff-index#Documentation/git-diff-index.txt-git-diff-filespattern)`git-diff-files` [_< pattern>_...]
...
##  [](https://git-scm.com/docs/git-diff-index#_diff_format_for_merges)diff format for merges
...
##  [](https://git-scm.com/docs/git-diff-index#generate_patch_text_with_p)Generating patch text with -p
...
##  [](https://git-scm.com/docs/git-diff-index#_combined_diff_format)Combined diff format
...
##  [](https://git-scm.com/docs/git-diff-index#_other_diff_formats)other diff formats
...
##  [](https://git-scm.com/docs/git-diff-index#_operating_modes)OPERATING MODES
...
##  [](https://git-scm.com/docs/git-diff-index#_cached_mode)CACHED MODE
...
##  [](https://git-scm.com/docs/git-diff-index#_non_cached_mode)NON-CACHED MODE
...
Note |  As with other commands of this type, _git diff-index_ does not actually look at the contents of the file at all. So maybe `kernel/sched.c` hasn't actually changed, and it's just that you touched it. In either case, it's a note that you need to _git update-index_ it to make the index be in sync.
---|---
...
---|---
##  [](https://git-scm.com/docs/git-diff-index#_git)GIT
