...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [URL Format](https://git-scm.com/docs/gitprotocol-http#_url_format)
    * [Authentication](https://git-scm.com/docs/gitprotocol-http#_authentication)
    * [SSL](https://git-scm.com/docs/gitprotocol-http#_ssl)
    * [Session State](https://git-scm.com/docs/gitprotocol-http#_session_state)
    * [General Request Processing](https://git-scm.com/docs/gitprotocol-http#_general_request_processing)
    * [Discovering References](https://git-scm.com/docs/gitprotocol-http#_discovering_references)
    * [Smart Service git-upload-pack](https://git-scm.com/docs/gitprotocol-http#_smart_service_git_upload_pack)
    * [Smart Service git-receive-pack](https://git-scm.com/docs/gitprotocol-http#_smart_service_git_receive_pack)
    * [REFERENCES](https://git-scm.com/docs/gitprotocol-http#_references)
    * [SEE ALSO](https://git-scm.com/docs/gitprotocol-http#_see_also)
    * [GIT](https://git-scm.com/docs/gitprotocol-http#_git)


[ English ▾](https://git-scm.com/docs/gitprotocol-http)
...
##  [](https://git-scm.com/docs/gitprotocol-http#_url_format)URL Format
...
##  [](https://git-scm.com/docs/gitprotocol-http#_authentication)Authentication
...
##  [](https://git-scm.com/docs/gitprotocol-http#_ssl)SSL
Clients and servers SHOULD support SSL, particularly to protect passwords when relying on Basic HTTP authentication.
##  [](https://git-scm.com/docs/gitprotocol-http#_session_state)Session State
...
##  [](https://git-scm.com/docs/gitprotocol-http#_general_request_processing)General Request Processing
...
##  [](https://git-scm.com/docs/gitprotocol-http#_discovering_references)Discovering References
...
###  [](https://git-scm.com/docs/gitprotocol-http#_dumb_clients)Dumb Clients
...
The Content-Type of the returned info/refs entity SHOULD be _text/plain; charset=utf-8_ , but MAY be any content type. Clients MUST NOT attempt to validate the returned Content-Type. Dumb servers MUST NOT return a return type starting with `application/x-git-`.
...
###  [](https://git-scm.com/docs/gitprotocol-http#_smart_clients)Smart Clients
...
####  [](https://git-scm.com/docs/gitprotocol-http#_dumb_server_response)Dumb Server Response
Dumb servers MUST respond with the dumb server reply format.
See the prior section under dumb clients for a more detailed description of the dumb server response.
####  [](https://git-scm.com/docs/gitprotocol-http#_smart_server_response)Smart Server Response
...
##  [](https://git-scm.com/docs/gitprotocol-http#_smart_service_git_upload_pack)Smart Service git-upload-pack
...
###  [](https://git-scm.com/docs/gitprotocol-http#_the_negotiation_algorithm)The Negotiation Algorithm
...
##  [](https://git-scm.com/docs/gitprotocol-http#_smart_service_git_receive_pack)Smart Service git-receive-pack
This service reads from the repository pointed to by `$GIT_URL`.
Clients MUST first perform ref discovery with _$GIT_URL/info/refs?service=git-receive-pack_.
```
...
TODO: Document this further.
##  [](https://git-scm.com/docs/gitprotocol-http#_references)REFERENCES
...
##  [](https://git-scm.com/docs/gitprotocol-http#_see_also)SEE ALSO
