...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [The Git index file has the following format](https://git-scm.com/docs/gitformat-index#_the_git_index_file_has_the_following_format)
    * [Index entry](https://git-scm.com/docs/gitformat-index#_index_entry)
    * [Extensions](https://git-scm.com/docs/gitformat-index#_extensions)
    * [Untracked cache](https://git-scm.com/docs/gitformat-index#_untracked_cache)
    * [File System Monitor cache](https://git-scm.com/docs/gitformat-index#_file_system_monitor_cache)
    * [End of Index Entry](https://git-scm.com/docs/gitformat-index#_end_of_index_entry)
    * [Index Entry Offset Table](https://git-scm.com/docs/gitformat-index#_index_entry_offset_table)
    * [Sparse Directory Entries](https://git-scm.com/docs/gitformat-index#_sparse_directory_entries)
    * [GIT](https://git-scm.com/docs/gitformat-index#_git)


[ English ▾](https://git-scm.com/docs/gitformat-index)
...
[ Latest version ▾ ](https://git-scm.com/docs/gitformat-index) gitformat-index last updated in 2.44.0
Changes in the **gitformat-index** manual
  1. 2.44.1 → 2.53.0 no changes
  2. [2.44.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2024-02-23_ ](https://git-scm.com/docs/gitformat-index/2.44.0)
  3. 2.40.1 → 2.43.7 no changes
  4. [2.40.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2023-03-12_ ](https://git-scm.com/docs/gitformat-index/2.40.0)
  5. 2.38.1 → 2.39.5 no changes
  6. [2.38.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2022-10-02_ ](https://git-scm.com/docs/gitformat-index/2.38.0)


Check your version of git by running
`git --version`
##  [](https://git-scm.com/docs/gitformat-index#_name)NAME
gitformat-index - Git index format
##  [](https://git-scm.com/docs/gitformat-index#_synopsis)SYNOPSIS
```
$GIT_DIR/index
```

##  [](https://git-scm.com/docs/gitformat-index#_description)DESCRIPTION
Git index format
##  [](https://git-scm.com/docs/gitformat-index#_the_git_index_file_has_the_following_format)The Git index file has the following format
```
...
##  [](https://git-scm.com/docs/gitformat-index#_index_entry)Index entry
```
...
(Version 4) In version 4, the entry path name is prefix-compressed
  ...
  for OFS_DELTA pack entries; see gitformat-pack[5][](https://git-scm.com/docs/gitformat-pack)) is stored, followed
...
##  [](https://git-scm.com/docs/gitformat-index#_extensions)Extensions
###  [](https://git-scm.com/docs/gitformat-index#_cache_tree)Cache tree
```
...
###  [](https://git-scm.com/docs/gitformat-index#_resolve_undo)Resolve undo
```
...
###  [](https://git-scm.com/docs/gitformat-index#_split_index)Split index
```
...
##  [](https://git-scm.com/docs/gitformat-index#_untracked_cache)Untracked cache
```
...
##  [](https://git-scm.com/docs/gitformat-index#_file_system_monitor_cache)File System Monitor cache
```
...
##  [](https://git-scm.com/docs/gitformat-index#_end_of_index_entry)End of Index Entry
```
...
##  [](https://git-scm.com/docs/gitformat-index#_index_entry_offset_table)Index Entry Offset Table
```
...
##  [](https://git-scm.com/docs/gitformat-index#_sparse_directory_entries)Sparse Directory Entries
```
