...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [SUBCOMMANDS](https://git-scm.com/docs/git-hook#_subcommands)
    * [OPTIONS](https://git-scm.com/docs/git-hook#_options)
    * [SEE ALSO](https://git-scm.com/docs/git-hook#_see_also)
    * [GIT](https://git-scm.com/docs/git-hook#_git)


[ English ▾](https://git-scm.com/docs/git-hook)
...
[ Latest version ▾ ](https://git-scm.com/docs/git-hook) git-hook last updated in 2.43.0
