...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [SYNTAX](https://git-scm.com/docs/gitmailmap#_syntax)
    * [NOTES](https://git-scm.com/docs/gitmailmap#_notes)
    * [EXAMPLES](https://git-scm.com/docs/gitmailmap#_examples)
    * [SEE ALSO](https://git-scm.com/docs/gitmailmap#_see_also)
    * [GIT](https://git-scm.com/docs/gitmailmap#_git)


[ English ▾](https://git-scm.com/docs/gitmailmap)
...
[ Latest version ▾ ](https://git-scm.com/docs/gitmailmap) gitmailmap last updated in 2.32.0
Changes in the **gitmailmap** manual
  ...
  3. 2.31.1 → 2.31.8 no changes
  4. [2.31.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2021-03-15_ ](https://git-scm.com/docs/gitmailmap/2.31.0)


Check your version of git by running
`git --version`
##  [](https://git-scm.com/docs/gitmailmap#_name)NAME
gitmailmap - Map author/committer names and/or E-Mail addresses
##  [](https://git-scm.com/docs/gitmailmap#_synopsis)SYNOPSIS
$GIT_WORK_TREE/.mailmap
##  [](https://git-scm.com/docs/gitmailmap#_description)DESCRIPTION
...
##  [](https://git-scm.com/docs/gitmailmap#_syntax)SYNTAX
...
##  [](https://git-scm.com/docs/gitmailmap#_notes)NOTES
...
##  [](https://git-scm.com/docs/gitmailmap#_examples)EXAMPLES
...
##  [](https://git-scm.com/docs/gitmailmap#_see_also)SEE ALSO
