...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [Creating a Git repository](https://git-scm.com/docs/gitcore-tutorial#_creating_a_git_repository)
    * [Populating a Git repository](https://git-scm.com/docs/gitcore-tutorial#_populating_a_git_repository)
    * [Committing Git state](https://git-scm.com/docs/gitcore-tutorial#_committing_git_state)
    * [Making a change](https://git-scm.com/docs/gitcore-tutorial#_making_a_change)
    * [Inspecting Changes](https://git-scm.com/docs/gitcore-tutorial#_inspecting_changes)
    * [Tagging a version](https://git-scm.com/docs/gitcore-tutorial#_tagging_a_version)
    * [Copying repositories](https://git-scm.com/docs/gitcore-tutorial#_copying_repositories)
    * [Creating a new branch](https://git-scm.com/docs/gitcore-tutorial#_creating_a_new_branch)
    * [Merging two branches](https://git-scm.com/docs/gitcore-tutorial#_merging_two_branches)
    * [Merging external work](https://git-scm.com/docs/gitcore-tutorial#_merging_external_work)
    * [How does the merge work?](https://git-scm.com/docs/gitcore-tutorial#_how_does_the_merge_work)
    * [Publishing your work](https://git-scm.com/docs/gitcore-tutorial#_publishing_your_work)
    * [Packing your repository](https://git-scm.com/docs/gitcore-tutorial#_packing_your_repository)
    * [Working with Others](https://git-scm.com/docs/gitcore-tutorial#_working_with_others)
    * [Working with Others, Shared Repository Style](https://git-scm.com/docs/gitcore-tutorial#_working_with_others_shared_repository_style)
    * [Bundling your work together](https://git-scm.com/docs/gitcore-tutorial#_bundling_your_work_together)
    * [SEE ALSO](https://git-scm.com/docs/gitcore-tutorial#_see_also)
    * [GIT](https://git-scm.com/docs/gitcore-tutorial#_git)


[ English ▾](https://git-scm.com/docs/gitcore-tutorial)
...
[ Latest version ▾ ](https://git-scm.com/docs/gitcore-tutorial) gitcore-tutorial last updated in 2.43.1
Changes in the **gitcore-tutorial** manual
  1. 2.43.2 → 2.53.0 no changes
  2. [2.43.1 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2024-02-09_ ](https://git-scm.com/docs/gitcore-tutorial/2.43.1)
  3. 2.25.2 → 2.43.0 no changes
  4. [2.25.1 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2020-02-17_ ](https://git-scm.com/docs/gitcore-tutorial/2.25.1)
  5. 2.23.1 → 2.25.0 no changes
  6. [2.23.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2019-08-16_ ](https://git-scm.com/docs/gitcore-tutorial/2.23.0)
  7. 2.16.6 → 2.22.5 no changes
  8. [2.15.4 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2019-12-06_ ](https://git-scm.com/docs/gitcore-tutorial/2.15.4)
  9. 2.14.6 no changes
  10. [2.13.7 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2018-05-22_ ](https://git-scm.com/docs/gitcore-tutorial/2.13.7)
  11. [2.12.5 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2017-09-22_ ](https://git-scm.com/docs/gitcore-tutorial/2.12.5)
  12. [2.11.4 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2017-09-22_ ](https://git-scm.com/docs/gitcore-tutorial/2.11.4)
  13. 2.10.5 no changes
  14. [2.9.5 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2017-07-30_ ](https://git-scm.com/docs/gitcore-tutorial/2.9.5)
  15. [2.8.6 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2017-07-30_ ](https://git-scm.com/docs/gitcore-tutorial/2.8.6)
  16. 2.5.6 → 2.7.6 no changes
  17. [2.4.12 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2017-05-05_ ](https://git-scm.com/docs/gitcore-tutorial/2.4.12)
  18. 2.3.10 no changes
  19. [2.2.3 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2015-09-04_ ](https://git-scm.com/docs/gitcore-tutorial/2.2.3)
  20. 2.1.4 no changes
  21. [2.0.5 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2014-12-17_ ](https://git-scm.com/docs/gitcore-tutorial/2.0.5)


Check your version of git by running
`git --version`
##  [](https://git-scm.com/docs/gitcore-tutorial#_name)NAME
gitcore-tutorial - A Git core tutorial for developers
##  [](https://git-scm.com/docs/gitcore-tutorial#_synopsis)SYNOPSIS
git *
##  [](https://git-scm.com/docs/gitcore-tutorial#_description)DESCRIPTION
This tutorial explains how to use the "core" Git commands to set up and work with a Git repository.
If you just need to use Git as a revision control system you may prefer to start with "A Tutorial Introduction to Git" ([gittutorial[7]](https://git-scm.com/docs/gittutorial)) or [the Git User Manual](https://git-scm.com/docs/user-manual).
...
##  [](https://git-scm.com/docs/gitcore-tutorial#_committing_git_state)Committing Git state
...
##  [](https://git-scm.com/docs/gitcore-tutorial#_making_a_change)Making a change
...
Note what happens to the different _git diff-*_ versions here. After we've updated `hello` in the index, `git` `diff-files` `-p` now shows no differences, but `git` `diff-index` `-p` `HEAD` still **does** show that the current state is different from the state we committed. In fact, now _git diff-index_ shows the same difference whether we use the `--cached` flag or not, since now the index is coherent with the working tree.
...
##  [](https://git-scm.com/docs/gitcore-tutorial#_inspecting_changes)Inspecting Changes
...
Note |  Here is an ASCII art by Jon Loeliger that illustrates how various _diff-*_ commands compare things. ```
            diff-tree
             +----+
             |    |
             |    |
...
which will sign the current `HEAD` (but you can also give it another argument that specifies the thing to tag, e.g., you could have tagged the current `mybranch` point by using `git` `tag` _< tagname>_ `mybranch`).
...
##  [](https://git-scm.com/docs/gitcore-tutorial#_creating_a_new_branch)Creating a new branch
...
##  [](https://git-scm.com/docs/gitcore-tutorial#_merging_two_branches)Merging two branches
...
##  [](https://git-scm.com/docs/gitcore-tutorial#_merging_external_work)Merging external work
...
##  [](https://git-scm.com/docs/gitcore-tutorial#_how_does_the_merge_work)How does the merge work?
...
##  [](https://git-scm.com/docs/gitcore-tutorial#_working_with_others_shared_repository_style)Working with Others, Shared Repository Style
...
See [gitcvs-migration[7]](https://git-scm.com/docs/gitcvs-migration) for the details.
##  [](https://git-scm.com/docs/gitcore-tutorial#_bundling_your_work_together)Bundling your work together
