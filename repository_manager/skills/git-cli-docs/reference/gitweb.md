...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [CONFIGURATION](https://git-scm.com/docs/gitweb#_configuration)
    * [ACTIONS, AND URLS](https://git-scm.com/docs/gitweb#_actions_and_urls)
    * [WEBSERVER CONFIGURATION](https://git-scm.com/docs/gitweb#_webserver_configuration)
    * [ADVANCED WEB SERVER SETUP](https://git-scm.com/docs/gitweb#_advanced_web_server_setup)
    * [BUGS](https://git-scm.com/docs/gitweb#_bugs)
    * [SEE ALSO](https://git-scm.com/docs/gitweb#_see_also)
    * [GIT](https://git-scm.com/docs/gitweb#_git)


[ English ▾](https://git-scm.com/docs/gitweb)
...
[ Latest version ▾ ](https://git-scm.com/docs/gitweb) gitweb last updated in 2.50.0
Changes in the **gitweb** manual
  ...
  19. 2.10.5 → 2.12.5 no changes
  20. [2.9.5 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2017-07-30_ ](https://git-scm.com/docs/gitweb/2.9.5)
  21. 2.1.4 → 2.8.6 no changes
  22. [2.0.5 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2014-12-17_ ](https://git-scm.com/docs/gitweb/2.0.5)


Check your version of git by running
`git --version`
##  [](https://git-scm.com/docs/gitweb#_name)NAME
gitweb - Git web interface (web frontend to Git repositories)
##  [](https://git-scm.com/docs/gitweb#_synopsis)SYNOPSIS
To get started with gitweb, run [git-instaweb[1]](https://git-scm.com/docs/git-instaweb) from a Git repository. This will configure and start your web server, and run a web browser pointing to gitweb.
##  [](https://git-scm.com/docs/gitweb#_description)DESCRIPTION
...
##  [](https://git-scm.com/docs/gitweb#_configuration)CONFIGURATION
Various aspects of gitweb's behavior can be controlled through the configuration file `gitweb_config.perl` or `/etc/gitweb.conf`. See the [gitweb.conf[5]](https://git-scm.com/docs/gitweb.conf) for details.
###  [](https://git-scm.com/docs/gitweb#_repositories)Repositories
...
###  [](https://git-scm.com/docs/gitweb#_projects_list_file_format)Projects list file format
...
By default this file controls only which projects are **visible** on projects list page (note that entries that do not point to correctly recognized Git repositories won't be displayed by gitweb). Even if a project is not visible on projects list page, you can view it nevertheless by hand-crafting a gitweb URL. By setting `$strict_export` configuration variable (see [gitweb.conf[5]](https://git-scm.com/docs/gitweb.conf)) to true value you can allow viewing only of repositories also shown on the overview page (i.e. only projects explicitly listed in projects list file will be accessible).
###  [](https://git-scm.com/docs/gitweb#_generating_projects_list_using_gitweb)Generating projects list using gitweb
...
###  [](https://git-scm.com/docs/gitweb#_controlling_access_to_git_repositories)Controlling access to Git repositories
By default all Git repositories under `$projectroot` are visible and available to gitweb. You can however configure how gitweb controls access to repositories.
  ...
  * You can configure gitweb to only list and allow viewing of the explicitly exported repositories, via `$export_ok` variable in gitweb config file; see [gitweb.conf[5]](https://git-scm.com/docs/gitweb.conf) manpage. If it evaluates to true, gitweb shows repositories only if this file named by `$export_ok` exists in its object database (if directory has the magic file named `$export_ok`).
For example [git-daemon[1]](https://git-scm.com/docs/git-daemon) by default (unless `--export-all` option is used) allows pulling only for those repositories that have _git-daemon-export-ok_ file. Adding
```
...
###  [](https://git-scm.com/docs/gitweb#_apache_as_cgi)Apache as CGI
...
###  [](https://git-scm.com/docs/gitweb#_apache_with_mod_perl_via_modperlregistry)Apache with mod_perl, via ModPerl::Registry
...
###  [](https://git-scm.com/docs/gitweb#_apache_with_fastcgi)Apache with FastCGI
...
##  [](https://git-scm.com/docs/gitweb#_advanced_web_server_setup)ADVANCED WEB SERVER SETUP
All of those examples use request rewriting, and need `mod_rewrite` (or equivalent; examples below are written for Apache).
###  [](https://git-scm.com/docs/gitweb#_single_url_for_gitweb_and_for_fetching)Single URL for gitweb and for fetching
...
###  [](https://git-scm.com/docs/gitweb#_webserver_configuration_with_multiple_projects_root)Webserver configuration with multiple projects' root
...
These configurations enable two things. First, each unix user (_< user>_) of the server will be able to browse through gitweb Git repositories found in `~/public_git/` with the following url:
```
http://git.example.org/~<user>/
```
...
###  [](https://git-scm.com/docs/gitweb#_path_info_usage)PATH_INFO usage
...
##  [](https://git-scm.com/docs/gitweb#_bugs)BUGS
Please report any bugs or feature requests to git@vger.kernel.org, putting "gitweb" in the subject of email.
##  [](https://git-scm.com/docs/gitweb#_see_also)SEE ALSO
[gitweb.conf[5]](https://git-scm.com/docs/gitweb.conf), [git-instaweb[1]](https://git-scm.com/docs/git-instaweb)
