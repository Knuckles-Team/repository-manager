...
5. **Domain-Specific Checks**:
   - **Git Status**: Check managed repositories for uncommitted changes or divergent branches.
   - **Outdated Remotes**: Identify local repositories that are significantly behind their remotes.
