...
def repository_manager_mcp():
    ...
    parser = argparse.ArgumentParser(
        add_help=False, description="Repository Manager MCP Utility"
    )
    parser.add_argument(
        "-t",
        "--transport",
...
def usage():
    print(
        f"Repository Manager ({__version__}): Repository Manager MCP Utility\n\n"
        "Usage:\n"
