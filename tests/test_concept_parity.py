...
# Paths
ROOT_DIR = '/home/apps/workspace/agent-packages/agents/repository-manager'
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in repository-manager
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in repository-manager but are NOT registered "
